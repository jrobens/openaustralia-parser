...
<?php
			if (isset($_SERVER['HTTP_USER_AGENT']) && !(mb_ereg("MSIE 4.0", $_SERVER['HTTP_USER_AGENT'])) && (isset($skinstyles["mobile"]))){
...
<?php
		...
		if (isset($skinstyles["print"]) && 
			$skinstyles["print"] != "" && 
			( isset($_SERVER['HTTP_USER_AGENT']) && !(mb_ereg("MSIE 4.0", $_SERVER['HTTP_USER_AGENT'])) )
		) {
			// Hide this from IE4 and Mac AOL5.
			?>
...
<?php
			if (isset($_SERVER['HTTP_USER_AGENT']) && !(mb_ereg("MSIE 4.0", $_SERVER['HTTP_USER_AGENT']))){
				// Hide this from IE4 and Mac AOL5.
				?>
	<style type="text/css">
